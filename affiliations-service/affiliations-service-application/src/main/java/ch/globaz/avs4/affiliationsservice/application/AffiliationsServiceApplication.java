package ch.globaz.avs4.affiliationsservice.application;

import ch.globaz.avs4.affiliationsservice.application.configuration.Profiles;
...
@EnableFeignClients(basePackages="ch.globaz.avs4.affiliationsservice.infrastructure.service")
@ComponentScan(basePackages = {"ch.globaz.avs4.affiliationsservice"})
public class AffiliationsServiceApplication {



	private final Environment env;
	private static final Logger LOGGER = LoggerFactory.getLogger(AffiliationsServiceApplication.class);

	public AffiliationsServiceApplication(Environment env) {
		this.env = env;
	}
	...
	public static void main(String []args)  {
		...
		SpringApplication app = new SpringApplication(AffiliationsServiceApplication.class);
