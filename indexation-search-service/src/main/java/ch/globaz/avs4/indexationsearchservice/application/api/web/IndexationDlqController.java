package ch.globaz.avs4.indexationsearchservice.application.api.web;

import ch.globaz.avs4.indexationsearchservice.infrastructure.dto.DlqDto;
...
public class IndexationDlqController {
	...
	public ResponseEntity<String> createDossiersSampleData(@RequestBody DlqDto dto){
